...
void draw() {  
  ...
  int warna=cp5.get(ColorWheel.class,"c").getRGB();
  print(int(red(warna)));
  print(';');
  print(int(green(warna)));
  print(';');
  print(int(blue(warna)));
  print(';');
  println();
  
  Arduino.write(str(int(red(warna))));
  Arduino.write(';');
  Arduino.write(str(int(green(warna))));
  Arduino.write(';');
  Arduino.write(str(int(blue(warna))));
  Arduino.write(';');
  Arduino.write('\n');
}
